...
-- Company Settings: users can only access their own settings
...
-- Invoice Counter: users can only access their own counters
...
-- Invoice Items: users can access items for their own invoices
